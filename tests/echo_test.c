...
{
	data->command.input = ft_strdup("simple test string");
	ASSERT_EQUAL(SUCCESS, echo_command(&data->command, write_to_buf));
...
{
	data->command.input = ft_strdup("     first string trimmed \"     second string not trimmed\"");
	ASSERT_EQUAL(SUCCESS, echo_command(&data->command, write_to_buf));
...
{
	data->command.input = ft_strdup("\"     first           string\"      second      string        trimmed");
	ASSERT_EQUAL(SUCCESS, echo_command(&data->command, write_to_buf));
